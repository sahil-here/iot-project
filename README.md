...
This repo contains code for a web application, which displays muscle workout data from IoT hub and show the real-time data in a line chart on the web page.
